        ...
        **kwargs
        ...
        pipeline = pipelines.CodePipeline(
            ...
            asset_publishing_code_build_defaults=pipelines.CodeBuildOptions(
                ...
                # Install specific cdk-assets version matching CDK lib version
                partial_build_spec=codebuild.BuildSpec.from_object({
                    "version": "0.2",
                    "phases": {
                        "install": {
                            "commands": [
                                # Install cdk-assets version matching aws-cdk-lib in requirements.txt
                                # This ensures schema compatibility (v48.x requires cdk-assets 2.120+)
                                "npm install -g cdk-assets@2.233.0"
                            ]
                        }
                    }
                }),
